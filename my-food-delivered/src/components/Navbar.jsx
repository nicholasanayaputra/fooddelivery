  ...
  return (
    <div className="max-w-[1640] mx-auto flex justify-between items-center p-4">
            ...
            <div className="flex items-center">
                ...
                <h1 className="text-2xl sm:text-3xl lg:text-4xl px-2">Rest <span className="font-bold">Burg</span>
                </h1>
        ...
        <h2 className="text-2xl p-4">Rest <span className="font-bold">Burg</span>
        </h2>
            <nav>
